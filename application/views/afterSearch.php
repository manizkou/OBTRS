<div class="container-fluid" style="min-height: 420px;">
	...
	<div class="row row-modify">
		<div class="col-md-6 col-sm-6">
			<center>
				<div class="well col-well"><strong>ONWARD</strong></div>
		...
		<div class="col-md-4" style=" position:relative; top: 5px;"><div class="well col-well"><a data-toggle="modal" href="#modifySearch" style="text-decoration: none; color: #fff;" >MODIFY SEARCH</a></div></div>
		<?php
			if($returndate!=NULL){
		?>
		<div class="col-md-6 col-sm-6">
			<center>
				<div class="well col-well"><strong>RETURN</strong></div>
				<span><?php echo $to; ?></span>
				<span class="glyphicon glyphicon-arrow-right"></span>
				<span><?php echo $from; ?></span>&nbsp;&nbsp;				
...
<ul class="row ulist">
<form method="post" action="<?php echo base_url();?>passenger_info" class="col-md-12" id="seat_form<?php echo $key->bus_id;?>" onsubmit="return validate(this);">
		<li>
			<div class="row">
				...
				<div class="col-md-12 table-col">
					<div class="collapse" id="collapseExample<?php echo $key->bus_id;?>">
						<div class="card card-block" style="padding-bottom: 50px;">
							<div class="row">
								<div class="col-md-6" id="hold" style="position: relative; top:30px; left:30px;">
									<table class="seat">
						...
						<div class="seat-list">
								...
								<div class="col-md-3 proceed">
									...
									<input type="hidden" id="fto<?php echo $key->bus_id;?>" value="" name="bookedseat" required>
									<input type="hidden" id="frto<?php echo $key->bus_id;?>" value="" name="tprice" required>
									<input type="hidden" id="tseat<?php echo $key->bus_id;?>" value="" name="tseat">
									<input type="hidden" id="bid" value="<?php echo $key->bus_id;?>" name="bid" name="endtime">
									<input type="hidden" id="starttimeid" value="<?php echo $startTime;?>" name="starttime">
									<input type="hidden" id="endtimeid" value="<?php echo $endTime;?>"
									name="endtime">
									<br>
									...
									<select name="pickpoint" id="" class="form-control" required="required">
										...
										?>
										<option value="<?php echo $pick->pickup_point; ?>"><?php echo $pick->pickup_point; ?></option>
										<?php endforeach; ?>
									</select>
									<input type="submit" value="PROCEED" class="btn btn-primary busSearch radoff-btn proceed-btn" id="togglee" disabled style="visibility:hidden;"></center>
									<script type="text/javascript">
...
?>	
<!-- MOdify search modal -->
<div class="modal fade" id="modifySearch" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title">Update Your Search</h4>
			</div>		
			<div class="modal-body" style="background-color: #e8ecf2;">
				
				<form class="form-inline" method="POST" action="<?php echo base_url();?>home/search" utf-decode>
				<div class="row">
					<div class="col-md-5">
					...
					<div class="col-md-2"><span style="font-size: 30px;">&#8652;</span></div>
				...
				placeholder="ONWARD DATE" required autocomplete="off" value="<?php echo set_value('onwarddate');?>" readonly="true">
			</div></div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<img src="<?php echo base_url();?>assets/img/bus.gif" alt="">
					</div>
...
<script>
    ...
    $(document).on('click', '#getUser', function(e){
     ...
     $.ajax({
          url: '<?php echo base_url();?>home/getdetails/'+uid,
          type: 'POST',
          dataType: 'html'
     })
     .done(function(data){
	...
	function validate(form) {
		 var options = document.getElementsByName("spam[]");
		if(form.options.checked==false) {
	...
	<script type="text/javascript">
		...
		var spann = document.getElementsByClassName("reviewclose")[0];
