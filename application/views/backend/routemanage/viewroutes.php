						...
						<div class="tab-content">        
							...
							?> 
								...
								<table class="table table-bordered table-responsive" data-toggle="table" data-url=""  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
									...
									<?php 
										$sn=1;
										foreach ($routeview as $key) {
									?>
										<tr>
											<td><?php echo $sn; ?></td>
											<td><?php echo $key->fplace;?>-><?php echo $key->tplace;?></td>
											 <td>
											<a class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>backend/routemanage/editroute/<?php echo $key->route_id;?>"><i class="fa fa-fw fa-edit"></i>Edit</a>
											<a href="<?php echo base_url(); ?>backend/routemanage/deleteroute/<?php echo $key->route_id;?>" class="btn btn-danger btn-sm"><i class="fa fa-fw fa-trash"></i>DELETE</a>
