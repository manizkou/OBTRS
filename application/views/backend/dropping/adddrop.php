						...
						<div class="panel-body">
							<div class="tab-content">        
								<div id="first" class="tab-pane fade in active">
									...
									<form action="<?php echo base_url();?>backend/droppingdetails/insertdrop" method="POST">
									...
									<div class="row">
									  <div class="form-group col-md-6">
									   ...
									   <div class="form-group col-md-6">
											...
											<input class="form-control" type="text" name="dpoint" placeholder="Add New Dropping Point" required>
									
										</div>
									</div>
									<div class="row">
										<div class="form-group col-md-6">
											<label for="start time" class=" col-form-label">Dropping Time:</label>
									
											<input type="text" placeholder="Dropping time" name="dtime" class="form-control" required>
										</div>
									</div>
