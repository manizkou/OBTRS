...
<!-- /all in one seo pack -->
	...
	#holder{	
	 ...
	 #place .seat{
	 background:url("images/availiable_seat.png") no-repeat scroll 0 0 transparent;
	 height:33px;
	 width:33px;
	 display:block;	 
	 }
...
<li style="background:url('images/availiable_seat.png') no-repeat scroll 0 0 transparent;">Available Seat</li>
