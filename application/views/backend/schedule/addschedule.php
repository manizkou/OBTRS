						...
						<div class="panel-body">
							<div class="tab-content">        
								<div id="first" class="tab-pane fade in active">
									...
									<form action="<?php echo base_url();?>backend/schedule/insertschedule" method="POST">
									...
									<div class="row">
									  <div class="form-group col-md-6">
											...
											<?php
											foreach ($businfo as $key) {
											?>
												<option value="<?php echo $key->bus_id;?>"><?php echo $key->bus_name;?>(<?php echo $key->reg_name;?>)</option>
												<?php
											}
											?>
