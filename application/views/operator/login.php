                ...
                <div class="col-md-6 col-md-offset-4">
                    <div class="login-panel panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Owners Login Page</h3>
                        </div>
                    ...
                    ?>
                        ...
                        ?>  
                            <form class="form-horizontal" action="<?php echo base_url();?>operator/agentlogin/admin_login" method="post">
                              <fieldset>
                                <div class="form-group">
                                    <label class="col-lg-3 control-label" for="inputDefault">E-mail</label>
                                    <div class="col-lg-9">
                                        <input type="email" class="form-control" id="inputDefault" placeholder="Enter E-mail" name="email">
                                    </div>
                                    <div class="row">
